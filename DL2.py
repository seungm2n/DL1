'''
    1. Intelligence(지능)
        ...
        4) 컴퓨터가 스스로 방법을 찾아냄 : 데이터를 기반으로 스스로 학습할 수 있음.
            - 알파고 : 컴퓨터에 바둑 경기의 규칙과 이전 경기의 많은 데이터를 알려줌.
                    ==> 컴퓨터가 스스로 바둑의 원리를 학습하여 바둑을 둘 수 있던 것임.
        5)                  파라미터 수정                     평가
                                ||                          /\
                                \/                          ||
    ...
    2. Artificial Intelligence(인공 지능)
        ...
        2) 머신 러닝 (Machine Learning)은 매우 구체적이고 엄밀한 정의를 가지고 있음.
            - 반복적인 학습을 통해 분류 성능을 점점 향상시킬 수 있느 ㄴ효율적인 알고리즘이 기계학습을 수행함.
        3) 요약
            - 학습(learning)
            - 빅데이터(Big Data)
            - 추론(Reasoning)
    ...
    3. 머신러닝 종류
        1) 지도학습(supervised learning)
            ...
            예) 고양이, 개를 구분할 때 고양이인지 개인지 레이블링된 데이터를 충분히 제공한 뒤에 학습을 하도록하는 과정이 필요.
                - 학습단게 => 예측모델 => 테스트 단계
    ...
    4. 회귀분석
        ...
        2) 회귀분석
            ...
            - 주택의 면적이 큰 경우 판매가격도 높은 경우가 많음,
                ...
                - 이 둘 사이에는 상관관계가 1차 방정식으로 표현 될 수 있는 선형관계랄고 함
